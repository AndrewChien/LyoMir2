namespace ScriptSystem.Consts
{
    ...
    public enum ConditionCode : short
    {
        ...
        [ScriptDefName("CHECKGAMEDIAMOND")]
        CHECKGAMEDIAMOND,

        [ScriptDefName("CHECKFENGHAO")]
        CHECKFENGHAO,

        [ScriptDefName("CHECKNGLEVEL")]
        CHECKNGLEVEL,

        [ScriptDefName("CHECKREADSKILLNG")]
        CHECKREADSKILLNG,

        [ScriptDefName("CHECKFLUTECOUNT")]
        CHECKFLUTECOUNT,

        [ScriptDefName("CHECKCASTLEWAR")]
        CHECKCASTLEWAR,

        [ScriptDefName("NOT")]
        NOT,

        [ScriptDefName("CHECKCALLGAMEPET")]
        CHECKCALLGAMEPET,

        [ScriptDefName("CHECKMAGICNAME")]
        CHECKMAGICNAME,

        [ScriptDefName("CHECKCURRTARGETRACE")]
        CHECKCURRTARGETRACE,

        [ScriptDefName("CHECKGAMEGIRD")]
        CHECKGAMEGIRD,

        [ScriptDefName("ISSAMEGUILDONMAP")]
        ISSAMEGUILDONMAP,

        [ScriptDefName("CHECKHEROONLINE")]
        CHECKHEROONLINE,
    }
}