    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddModules(this IServiceCollection services)
        {
            ...
            foreach (ModuleInfo module in modules)
            {
                ...
                {
                    TryLoadModuleAssembly(module.Id, module);//1、根据ID加载
                ...
                {
                    module.Assembly = Assembly.LoadFile(modulePath);//2、直接加载
                }

                GameShare.Modules.Add(module);//将已加载插件放入GameShare.Modules
            }
            return services;
        }
