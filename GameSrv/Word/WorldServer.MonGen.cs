...
namespace GameSrv.Word
{
    public partial class WorldServer
    {
        ...
        {
            LogService.Info($"Run monster threads:[{SystemShare.Config.ProcessMonsterMultiThreadLimit}]");
        ...
        private void ProcessMonsters(MonsterThread monsterThread)
        {
            ...
            LogService.Info($"MonsterProcess Thread:{monsterThread.Id} Monsters:{mongenList.Count} starting work.");
