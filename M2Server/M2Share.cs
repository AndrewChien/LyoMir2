...
namespace M2Server
{
    ...
    public static class M2Share
    {
        ...
        /// <summary>
        /// 加载禁止出售物品列表DisableSellOffItem.txt
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// 加载怪物限制掉落物品列表MonDropLimitList.txt
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// 加载禁止脱下物品列表DisableTakeOffList.txt
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns>返回 FALSE 为记录,返回 TRUE  为不记录</returns>
